...
!((a) => {
	if ("undefined" != typeof window) {
		var r = !0,
			...
			$ = () => {},
			_ = {
				height: () => (x("Custom height calculation function not defined"), document.documentElement.offsetHeight),
				width: () => (x("Custom width calculation function not defined"), document.body.scrollWidth),
			},
			ee = {},
			te = !1;
		try {
		...
		var oe,
			...
			A,
			C = {
				bodyOffset: () => document.body.offsetHeight + ye("marginTop") + ye("marginBottom"),
				offset: () => C.bodyOffset(),
				bodyScroll: () => document.body.scrollHeight,
				custom: () => _.height(),
				documentElementOffset: () => document.documentElement.offsetHeight,
				documentElementScroll: () => document.documentElement.scrollHeight,
				max: () => Math.max.apply(null, e(C)),
				min: () => Math.min.apply(null, e(C)),
				grow: () => C.max(),
				lowestElement: () => Math.max(C.bodyOffset() || C.documentElementOffset(), we("bottom", Te())),
				taggedElement: () => be("bottom", "data-iframe-height"),
			},
			z = {
				...
				scroll: () => Math.max(z.bodyScroll(), z.documentElementScroll()),
				max: () => Math.max.apply(null, e(z)),
				min: () => Math.min.apply(null, e(z)),
				rightMostElement: () => we("right", Te()),
				taggedElement: () => be("right", "data-iframe-width"),
			},
			re =
				((oe = Ee),
				(N = null),
				...
				function () {
					...
					return (
						...
						(I = arguments),
						t <= 0 || O < t
							? (N && (clearTimeout(N), (N = null)), (A = e), (ie = oe.apply(o, I)), N || (o = I = null))
							: (N = N || setTimeout(Oe, t)),
						ie
					);
				});
			...
			function e() {
				...
				e in n
					...
					: (("undefined" == typeof module || !module.exports) && "iFrameResize" in window) ||
						(window.jQuery !== a && "iFrameResize" in window.jQuery.prototype) ||
						r() ||
						x("Unexpected message (" + t.data + ")");
			}
			y === ("" + t.data).slice(0, J) &&
				(!1 === q ? e() : r() ? n.init() : R('Ignored message of type "' + o() + '". Received before initialization.'));
		}),
		...
		R("TargetOrigin for parent set to: " + T),
			...
			(Q.parentIFrame = {
				autoResize: (e) => (
					!0 === e && !1 === r
						? ((r = !0), pe())
						: !1 === e && !0 === r && ((r = !1), fe("remove"), null !== s && s.disconnect(), clearInterval(B)),
				...
				getId: () => w,
				getPageInfo: (e) => {
					"function" == typeof e ? (($ = e), F(0, 0, "pageInfo")) : (($ = () => {}), F(0, 0, "pageInfoStop"));
				},
				moveToAnchor: (e) => {
					h.findTarget(e);
				},
			...
			(h = (() => {
				function n(e) {
					...
					return {
						x: Number.parseInt(e.left, 10) + Number.parseInt(t.x, 10),
						y: Number.parseInt(e.top, 10) + Number.parseInt(t.y, 10),
					};
				}
				function o(e) {
					var e = e.split("#")[1] || e,
					...
					a === t
						? (R("In page link (#" + e + ") not found in iFrame, so sending to parent"), F(0, 0, "inPageLink", "#" + e))
						: ((t = n((t = t))),
				...
				function i() {
					Array.prototype.forEach && document.querySelectorAll
						? (R("Setting up location.hash handlers"), t(), k(window, "hashchange", e), setTimeout(e, l))
						: x("In page linking not fully supported in this browser! (See README.md for IE8 workaround)");
				}
	...
	function be(e, t) {
		...
		return (
			0 === n.length && (x("No tagged elements (" + t + ") found on page"), document.querySelectorAll("body *")),
			we(e, n)
		);
	}
	function Te() {
	...
	function L(e, t, n, o) {
		i && e in j
			...
			: (e in { reset: 1, resetPage: 1, init: 1 } || R("Trigger event: " + t), ("init" === e ? Ee : re)(e, t, n, o));
	}
	function Se() {
